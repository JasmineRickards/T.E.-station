/obj/machinery/fax
	...
	var/list/special_networks = list(
		nanotrasen = list(fax_name = "Nanotrasen Regional Command", fax_id = "central_command", color = "teal", emag_needed = FALSE),
		syndicate = list(fax_name = "Syndicate Regional Command", fax_id = "syndicate", color = "red", emag_needed = TRUE),
	)
