/obj/vehicle/sealed/mecha/marauder
	...
	movedelay = 5
	max_integrity = 600
	armor = list(MELEE = 70, BULLET = 65, LASER = 50, ENERGY = 30, BOMB = 30, BIO = 0, FIRE = 100, ACID = 100)
...
/obj/vehicle/sealed/mecha/marauder/loaded
	equip_by_category = list(
		...
		MECHA_UTILITY = list(/obj/item/mecha_parts/mecha_equipment/thrusters/ion/internal),
		MECHA_POWER = list(),
