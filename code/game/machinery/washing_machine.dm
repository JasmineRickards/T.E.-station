...
GLOBAL_LIST_INIT(dye_registry, list(
	...
	DYE_REGISTRY_BEDSHEET = list(
		DYE_RED = /obj/item/bedsheet/red/huge,
		DYE_ORANGE = /obj/item/bedsheet/orange/huge,
		DYE_YELLOW = /obj/item/bedsheet/yellow/huge,
		DYE_GREEN = /obj/item/bedsheet/green/huge,
		DYE_BLUE = /obj/item/bedsheet/blue/huge,
		DYE_PURPLE = /obj/item/bedsheet/purple/huge,
		DYE_BLACK = /obj/item/bedsheet/black/huge,
		DYE_WHITE = /obj/item/bedsheet/huge,
		DYE_RAINBOW = /obj/item/bedsheet/rainbow/huge,
		DYE_MIME = /obj/item/bedsheet/mime/huge,
		DYE_CLOWN = /obj/item/bedsheet/clown/huge,
		DYE_CHAP = /obj/item/bedsheet/chaplain/huge,
		DYE_QM = /obj/item/bedsheet/qm/huge,
		DYE_LAW = /obj/item/bedsheet/black/huge,
		DYE_CAPTAIN = /obj/item/bedsheet/captain/huge,
		DYE_HOP = /obj/item/bedsheet/hop/huge,
		DYE_HOS = /obj/item/bedsheet/hos/huge,
		DYE_CE = /obj/item/bedsheet/ce/huge,
		DYE_RD = /obj/item/bedsheet/rd/huge,
		DYE_CMO = /obj/item/bedsheet/cmo/huge,
		DYE_COSMIC = /obj/item/bedsheet/cosmos/huge,
		DYE_SYNDICATE = /obj/item/bedsheet/syndie/huge,
		DYE_CENTCOM = /obj/item/bedsheet/centcom/huge
	),
		DYE_REGISTRY_DOUBLE_BEDSHEET = list(
		DYE_RED = /obj/item/bedsheet/red/double/huge,
		DYE_ORANGE = /obj/item/bedsheet/orange/double/huge,
		DYE_YELLOW = /obj/item/bedsheet/yellow/double/huge,
		DYE_GREEN = /obj/item/bedsheet/green/double/huge,
		DYE_BLUE = /obj/item/bedsheet/blue/double/huge,
		DYE_PURPLE = /obj/item/bedsheet/purple/double/huge,
		DYE_BLACK = /obj/item/bedsheet/black/double/huge,
		DYE_WHITE = /obj/item/bedsheet/double/huge,
		DYE_RAINBOW = /obj/item/bedsheet/rainbow/double/huge,
		DYE_MIME = /obj/item/bedsheet/mime/double/huge,
		DYE_CLOWN = /obj/item/bedsheet/clown/double/huge,
		DYE_CHAP = /obj/item/bedsheet/chaplain/double/huge,
		DYE_QM = /obj/item/bedsheet/qm/double/huge,
		DYE_LAW = /obj/item/bedsheet/black/double/huge,
		DYE_CAPTAIN = /obj/item/bedsheet/captain/double/huge,
		DYE_HOP = /obj/item/bedsheet/hop/double/huge,
		DYE_HOS = /obj/item/bedsheet/hos/double/huge,
		DYE_CE = /obj/item/bedsheet/ce/double/huge,
		DYE_RD = /obj/item/bedsheet/rd/double/huge,
		DYE_CMO = /obj/item/bedsheet/cmo/double/huge,
		DYE_COSMIC = /obj/item/bedsheet/cosmos/double/huge,
		DYE_SYNDICATE = /obj/item/bedsheet/syndie/double/huge,
		DYE_CENTCOM = /obj/item/bedsheet/centcom/double/huge
	),
