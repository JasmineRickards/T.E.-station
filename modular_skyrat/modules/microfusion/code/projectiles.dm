...
/obj/projectile/beam/laser/microfusion/superheated
	...
	damage = 25 //Trading damage for fire stacks
...
/obj/projectile/beam/laser/microfusion/hellfire
	...
	icon_state = "laser_greyscale"
	wound_bonus = 0
	damage = 25 // You are trading damage for a significant wound bonus and speed increase
	speed = 0.6
...
/obj/projectile/beam/laser/microfusion/lance
	...
	damage = 80 // Were turning the gun into a heavylaser
